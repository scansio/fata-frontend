  ...
  function computeValue (result, field, index) {
    ...
    if (fields[field]?.virtual) {
      ...
      return props.noDoubleClick ? (
        ...
        <DoubleClickCopy noClickOpen={props.noClickOpen}>{val} </DoubleClickCopy>
      )
    }
  }
        ...
        <Col sm="12">
          {props.type == 'card' ? (
            <Spinner loading={loading} loadingError={loadingError}>
              <div
                className={props.cardNotCentered ? 's-start-grid' : 's-grid-justify'}
              >
            ...
            <Table
              ...
              hover
              style={
                props?.style?.tableStyle ? props.style.tableStyle : props.style
              }
              className={`${
            ...
            >
              ...
              >
                <Spinner
                  ...
                  table={{ colspan: fieldKeys.length }}
                >
                  {results?.map((result, resultIndex) => {
                    // Row
                    const rowOptions =
